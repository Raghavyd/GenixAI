...
import { Eraser, FileText, Hash, House,  Image, LogOut, Menu, Scissors, SquarePen, Users, X } from 'lucide-react'
...
const Sidebar = ({sidebar,setSidebar}) => {
  ...
  return (
    ...
    <div className='my-7 w-full'>
      ...
      <div className='w-full border-t border-gray-200 p-4 gap-8 px-7 flex items-center justify-center'>
