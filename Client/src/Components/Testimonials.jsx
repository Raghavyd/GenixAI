export default function Testimonials() {
    return (
        <div className="text-center">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-800">What Our Clients Say</h1>
            <p className="text-sm md:text-base text-gray-500 mt-4">Join thousand of successful clients who transformed their careers with us</p>
